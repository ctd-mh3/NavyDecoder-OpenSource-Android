...
- Copied Billet Code and Billet Description columns to new "Billet Codes" tab
  - Deleted rows for subsection titles (e.g. "Unrestricted Line (Aviation)")
  - Remove any "NOTE below applies"
  - Remove "*" and spaces from billet codes
  - Use formula to create SQL statements
- Copied Officer Code and Officer Description columns to new "Description Codes" tab
  - Deleted all rows that do not end with an "X"
  - Use formula to create SQL statements