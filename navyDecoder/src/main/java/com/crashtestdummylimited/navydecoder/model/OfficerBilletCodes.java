...
public class OfficerBilletCodes implements ReferenceData {
  ...
  public OfficerBilletCodes() {
    String[][] CODE_MEANING_DATA = {
        ...
        {"1520", "Aerospace Engineering Duty Officer billet requiring Aerospace Maintenance (AMD) specialty"},
        ...
        {"1802", "Information Warfare Line Officer billet Code 2 - Operational Flying, requiring Meteorology specialty of a Geophysicist who is a designated Pilot or Naval Flight Officer"},
        {"1810", "Information Warfare Line Officer – Cryptologic Warfare Officer"},
        {"1820", "Information Warfare Line Officer – Communications Systems Warfare Officer (CSWO)"},
        ...
        {"1870", "Information Warfare Line Officer – Maritime Space Officer Warfare – Qualified URL/RL officers at O3, O4, O5 and O6 level and Reserve Grades URL/RL at O2 to O6 level"},
        ...
        {"7901", "Chief Warrant Officer (Line)"},
        {"7904", "Chief Warrant Officer (Line)"},
    };
