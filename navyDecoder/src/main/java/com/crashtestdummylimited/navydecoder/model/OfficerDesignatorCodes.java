...
public class OfficerDesignatorCodes implements ReferenceData {
  ...
  public OfficerDesignatorCodes() {
    String[][] CODE_MEANING_DATA = {
      ...
      {
        "114X",
        "An Unrestricted Line Officer who is qualified in Explosive Ordnance Disposal (EOD) Warfare"
      },
      ...
      {
        "119X",
        "Unrestricted Line Officer who is in training for Explosive Ordnance Disposal qualification"
      },
      {
        "120X",
        "Special Duty Officer - Human Resource Officer A Restricted Line Officer of the Human Resources Community who will plan, program and execute life-cycle management of our Navy's most important resource - people."
      },
      {
        "121X",
        "Restricted Line Officer (Nuclear Power School Instructor) regulated by Program Authorization 100B."
      },
      {
        "1230",
        "Restricted Line Officer (Permanent Military Professor) regulated by OPNAVINST 1520.40"
      },
      {
        "128X",
        "Special Duty Officer-Permanent Professional Recruiter Officer (Reserve Recruiting) (LT and LCDR)"
      },
      {
        "130X",
        "An Unrestricted Line Officer who is a member of the aeronautical community and whose rating as a pilot or NFO has been terminated. (These officers may be assigned to 1000, 1050, 1300, 1310 or 1320 designated billets, if otherwise qualified.)"
      },
      {
        "131X",
        "An Unrestricted Line Officer who is qualified for duty involving flying heavier-than-air, or heavier and lighter-than-air type of aircraft as a pilot"
      },
      {
        "132X",
        "An Unrestricted Line Officer who is qualified for duty involving flying heavier-than-air or heavier and lighter-than-air type aircraft as a Naval Flight Officer"
      },
      {
        "137X",
        "An Unrestricted Line Officer who is in training for duty involving flying as a Naval Flight Officer"
      },
      {
        "139X",
        "An Unrestricted Line Officer who is in training for duty involving flying as a pilot"
      },
      {
        "144X",
        "Engineering Duty Officer who is qualified as a Ship Engineering specialist IAW MILPERSMAN 1210-190. They include specialists in Ship and Ship systems Engineering, Electronic Systems Engineering, Combat/Weapons Systems Engineering, and Ordnance Systems Engineering"
      },
      {
        "146X",
        "Engineering Duty Officer who is in the process of completing the prescribed program leading to designation as 144X"
      },
      {
        "150X",
        "A Restricted Line AED Flag Officer or Captain who was formerly either an AED officer (Aerospace Engineering--designator 151X) or an AMD officer (Aviation Maintenance--designator 152X)"
      },
      ...
      {
        "191X",
        "An Unrestricted Line Officer under instruction as a prospective Medical Corps officer (Senior Medical Student)"
      },
      {
        "192X",
        "An Unrestricted Line Officer under instruction as a prospective Dental Corps officer"
      },
      {
        "193X",
        "An Unrestricted Line Officer under instruction as a prospective Medical Service officer (Optometry)"
      },
      {
        "194X",
        "An Unrestricted Line Officer under instruction as a prospective Chaplain Corps officer"
      },
      {
        "195X",
        "An Unrestricted Line Officer under instruction as a prospective Judge Advocate General's Corps officer"
      },
      {
        "196X",
        "An Unrestricted Line Officer under instruction as a prospective Medical Corps officer (Medical /Osteopathic Scholarship Program)"
      },
      {
        "197X",
        "An Unrestricted Line Officer under instruction in the Armed Forces Health Professions Scholarship Program (Medical/Osteopathic)"
      },
      {
        "198X",
        "An Unrestricted Line Officer under instruction in the Armed Forces Health Professions Scholarship Program (Dental)"
      },
      {
        "199X",
        "An Unrestricted Line Officer under instruction in the Armed Forces Health Professions Scholarship Program (Medical Service Corps)"
      },
      ...
      {
        "270X",
        "Active duty Nurse Corps, Medical Service Corps, Medical Corps, and Dental Corps officer in rank of O7"
      },
