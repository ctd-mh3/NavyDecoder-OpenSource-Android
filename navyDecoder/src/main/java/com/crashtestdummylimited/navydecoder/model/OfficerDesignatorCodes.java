...
public class OfficerDesignatorCodes implements ReferenceData {
  ...
  public OfficerDesignatorCodes() {
    String[][] CODE_MEANING_DATA = {
        ...
        {"152X", "Aerospace Engineering Duty Officer - Aviation Maintenance"},
        ...
        {"182X", "Information Warfare Line Officer – Communications Systems Warfare Officer (CSWO)"},
        ...
        {"187X", "Information Warfare Line Officer - Maritime Space Officer - Reserve Grades URL/RL O2 to O6"},
